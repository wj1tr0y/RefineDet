...
def AddExtraLayers(net, arm_source_layers=[], use_batchnorm=True):
    ...
    # 512/64: 8 x 8
    ResidualBlock(net, from_layer, '6', out2a=32, out2b=32, stride=2, use_branch1=True)
    ...
    for index, layer in enumerate(arm_source_layers):
        ...
        ConvBNLayer(net, from_layer, out_layer, use_batchnorm, use_relu, 48, 3, 1, 1)
        ...
        if num_p == 6:
            ...
            from_layer = out_layer
            out_layer = "TL{}_{}".format(num_p, 2)
            ConvBNLayer(net, from_layer, out_layer, use_batchnorm, False, 48, 3, 1, 1)

            from_layer = "P{}".format(num_p+1)
            out_layer = "P{}-up".format(num_p+1)
            DeconvBNLayer(net, from_layer, out_layer, use_batchnorm, False, 48, 2, 0, 2)
...
job_name = "refinedet_resnet18_743_{}".format(resize)
...
pretrain_model = "models/ResNet/coco/refinedet_resnet18_743_1024x1024/coco_refinedet_resnet18_743_1024x1024_iter_1000.caffemodel"
# # Stores LabelMapItem.
...
ResNet18Body1(net, from_layer='data', use_pool5=False, use_dilation_conv5=False)
