...
job_name = "refinedet_resnet18_neg_{}".format(resize)
...
pretrain_model = "models/ResNet/coco/refinedet_resnet18_1024x1024/coco_refinedet_resnet18_1024x1024_iter_160000.caffemodel"
# Stores LabelMapItem.
