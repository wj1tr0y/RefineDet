...
PeleeNetBody(net, from_layer='data', growth_rate=32, block_config=[1,2,3,3,2], bottleneck_width=[1,2,4,4,2])
...
PeleeNetBody(net, from_layer='data', growth_rate=16, block_config=[1,2,3,3,2], bottleneck_width=[1,2,4,4,2])
