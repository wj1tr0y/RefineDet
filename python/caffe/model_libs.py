...
@LastEditTime: 2019-04-08 20:31:06
'''
import os
...
def ResNet18BigBody(net, from_layer, use_pool5=True, use_dilation_conv5=False, **bn_param):
    conv_prefix = ''
    conv_postfix = ''
    bn_prefix = 'bn_'
    bn_postfix = ''
    ...
    ResidualBlock(net, 'pool1', '2a', out2a=32, out2b=32, stride=2, use_branch1=True, **bn_param)
    ResidualBlock(net, 'res2a', '2b', out2a=32, out2b=32, stride=1, use_branch1=False, **bn_param)
