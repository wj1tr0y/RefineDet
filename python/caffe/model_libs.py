...
def VGGLiteBody(net, from_layer, need_fc=True, fully_conv=False, reduced=False,
    ...
    net.conv1_1 = L.Convolution(net[from_layer], num_output=32, pad=1, kernel_size=3, stride=2, **kwargs)
    net.relu1_1 = L.ReLU(net.conv1_1, in_place=True)
    net.conv1_2 = L.Convolution(net.relu1_1, num_output=32, pad=0, kernel_size=1, **kwargs)
    ...
    net.conv2_2 = L.Convolution(net.relu2_1, num_output=32, pad=0, kernel_size=1, **kwargs)
    net.relu2_2 = L.ReLU(net.conv2_2, in_place=True)
    name = 'pool2'
    net[name] = L.Pooling(net.relu2_2, pool=P.Pooling.MAX, kernel_size=2, stride=2)


    net.conv3_1 = L.Convolution(net[name], num_output=48, pad=1, kernel_size=3, **kwargs)
    net.relu3_1 = L.ReLU(net.conv3_1, in_place=True)
    net.conv3_2 = L.Convolution(net.relu3_1, num_output=48, pad=0, kernel_size=1, **kwargs)
    net.relu3_2 = L.ReLU(net.conv3_2, in_place=True)
    net.conv3_3 = L.Convolution(net.relu3_2, num_output=48, pad=1, kernel_size=3, **kwargs)
    net.relu3_3 = L.ReLU(net.conv3_3, in_place=True)
    name = 'pool3'
    net[name] = L.Pooling(net.relu3_3, pool=P.Pooling.MAX, kernel_size=2, stride=2)


    net.conv4_1 = L.Convolution(net[name], num_output=64, pad=1, kernel_size=3, **kwargs)
    net.relu4_1 = L.ReLU(net.conv4_1, in_place=True)
    net.conv4_2 = L.Convolution(net.relu4_1, num_output=64, pad=0, kernel_size=1, **kwargs)
    net.relu4_2 = L.ReLU(net.conv4_2, in_place=True)
    net.conv4_3 = L.Convolution(net.relu4_2, num_output=64, pad=1, kernel_size=3, **kwargs)
    ...
    net.conv5_2 = L.Convolution(net.relu5_1, num_output=128, pad=0, kernel_size=1, dilation=1, **kwargs)
    ...
    net.conv6_2 = L.Convolution(net.relu5_1, num_output=128, pad=0, kernel_size=1, dilation=1, **kwargs)
    net.relu6_2 = L.ReLU(net.conv6_2, in_place=True)
    net.conv6_3 = L.Convolution(net.relu5_2, num_output=128, pad=1, kernel_size=3, dilation=1, **kwargs)
