...
@LastEditTime: 2019-04-02 19:31:41
'''
import os
...
def DepthwiseConvBNLayer(net, from_layer, out_layer, use_bn, use_relu, num_output,
    kernel_size, pad, stride, dilation=1, use_scale=True, lr_mult=1,
    conv_prefix='', conv_postfix='', bn_prefix='', bn_postfix='_bn',
    scale_prefix='', scale_postfix='_scale', bias_prefix='', bias_postfix='_bias',
    **bn_params):
...
def DepthwiseResidualBlock(net, from_layer, block_name, input_channel, out2a, out2b, stride, use_branch1, dilation=1, **bn_param):
    ...
    DepthwiseConvBNLayer(net, from_layer, branch_name, use_bn=True, use_relu=True,
...
def DepthwiseResBody(net, from_layer, block_name, input_channel, out2a, out2b, out2c, stride, use_branch1, dilation=1, **bn_param):
...
def ResNet18Body(net, from_layer, use_pool5=True, use_dilation_conv5=False, **bn_param):
    ...
    ResidualBlock(net, 'res3a', '3b', input_channel=64, out2a=64, out2b=64, stride=1, use_branch1=False, **bn_param)

    DepthwiseResidualBlock(net, 'res3b', '4a', input_channel=64, out2a=128, out2b=128, stride=2, use_branch1=True, **bn_param)
    ResidualBlock(net, 'res4a', '4b', input_channel=128, out2a=128, out2b=128, stride=1, use_branch1=False, **bn_param)
    ...
    ResidualBlock(net, 'res5a', '5b', input_channel=256, out2a=256, out2b=256, stride=1, use_branch1=False, dilation=dilation, **bn_param)
